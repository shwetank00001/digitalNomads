  ...
  return (
    <div className='bg-[#111111] px-5 py-10 sm:px-10 xl:px-50 3xl:px-100 lg:py-40 gap-20 '>
      <div className='gap-10 text-white 2xl:flex items-center justify-center'>
          <div className=''>
              <div>
                  <p className='uppercase text-xs sm:text-md md:text-md'>Digital Marketing Sunshine coast</p>
              </div>
              <br/>
              <div>
                  <p className='text-5xl font-semibold'>Marketing isn't about shouting the loudest; <span className='text-[#F34D01]'>it's about resonating the deepest...</span></p>
              </div>
          </div>
          <br/>
          <div>
